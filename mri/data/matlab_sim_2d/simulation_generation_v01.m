...
kloc_dcf_name='/local_mount/space/tiger/1/users/xc/share/spi_mrf_pack_sim/spiMRF_pack/kloc_dcf/ge/mrf3d_s5/klocdcf_mrf3ds5_t4gmax4_f2212n16_16882000.mat';% the path of kspace location and DCF
...
% img_temp=bart(['nufft -i -d ' num2str(effMtx) ':' num2str(effMtx) ':' num2str(effMtx) ' -t'],crds_ii,kspace_signal_frame);
